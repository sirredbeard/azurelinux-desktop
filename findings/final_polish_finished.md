...
## ARCHIVED: deliverable-polish-batch — fix tracker, preflight, and validation guide (2026-07-22)

This section was the active working record during the `deliverable-polish-batch`
iteration. It contains the full fix tracker table (a), preflight closure
evidence, and the post-build validation guide with per-issue filesystem and
runtime checks.
...
## ARCHIVED: Post-build artifact validation guide (2026-07-22 deliverable-polish-batch)
...
## ARCHIVED: Full rebuild/runtime-verification results (2026-07-22)
...
## ARCHIVED: Plymouth Boot-Splash Remediation Report (full, 2026-07-22)

> Note: Issue 1 (GRUB gfxterm) and Issue 4 (Plymouth scale script) are also archived
> in earlier sections above. This is the complete consolidated report including
> Issues 2 and 3 analysis, cross-cutting initramfs notes, and upstream references.
